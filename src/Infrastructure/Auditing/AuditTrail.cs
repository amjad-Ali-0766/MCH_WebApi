...
public class AuditTrail
{
    ...
    // here below "EntityEntry" class is store complete table with column data
    ...
    public Trail ToAuditTrail() =>
        new()
        {
            ...
            NewValues = NewValues.Count == 0 ? null : _serializer.Serialize(NewValues),// is ma os table ka data ho ga jis ma koi change kia ha
