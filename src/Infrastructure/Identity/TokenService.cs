...
using MCH.Application.Identity.Tokens;
using MCH.Infrastructure.Auth;
using MCH.Infrastructure.Auth.Jwt;
...
internal class TokenService : ITokenService
{
    ...
    private IEnumerable<Claim> GetClaims(ApplicationUser user, string ipAddress) =>
        new List<Claim>
        {
            ...
            new(MCHClaims.Fullname, $"{user.FirstName} {user.LastName}"),
            new(ClaimTypes.Name, user.FirstName ?? string.Empty),
            new(ClaimTypes.Surname, user.LastName ?? string.Empty),
            new(MCHClaims.IpAddress, ipAddress),
            new(MCHClaims.Tenant, _currentTenant!.Id),
            new(MCHClaims.ImageUrl, user.ImageUrl ?? string.Empty),
