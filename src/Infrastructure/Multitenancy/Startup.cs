...
internal static class Startup
{
    internal static IServiceCollection AddMultitenancy(this IServiceCollection services)
    {
        return services
            ...
            .AddMultiTenant<MCHTenantInfo>()
                .WithClaimStrategy(MCHClaims.Tenant)
                .WithHeaderStrategy(MultitenancyConstants.TenantIdName)
                .WithQueryStringStrategy(MultitenancyConstants.TenantIdName)
                .WithEFCoreStore<TenantDbContext, MCHTenantInfo>()
                .Services
    ...
    private static FinbuckleMultiTenantBuilder<MCHTenantInfo> WithQueryStringStrategy(this FinbuckleMultiTenantBuilder<MCHTenantInfo> builder, string queryStringKey) =>
