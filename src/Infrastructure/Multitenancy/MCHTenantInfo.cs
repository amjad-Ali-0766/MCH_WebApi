...
public class MCHTenantInfo : ITenantInfo
{
    public MCHTenantInfo()
    {
    }

    public MCHTenantInfo(string id, string name, string? connectionString, string adminEmail, string? issuer = null)
    {
        Id = id;
        Identifier = id;
        Name = name;
