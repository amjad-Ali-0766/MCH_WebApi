...
using MCH.Application.Identity.Users.Password;

namespace MCH.Host.Controllers.Identity;
...
public class UsersController : VersionNeutralApiController
{
    ...
    [HttpGet]
    [MustHavePermission(MCHAction.View, MCHResource.Users)]
    ...
    [HttpGet("{id}/roles")]
    [MustHavePermission(MCHAction.View, MCHResource.UserRoles)]
    ...
    [MustHavePermission(MCHAction.Update, MCHResource.UserRoles)]
    ...
    [HttpPost]
    [MustHavePermission(MCHAction.Create, MCHResource.Users)]
    ...
    [MustHavePermission(MCHAction.Update, MCHResource.Users)]
    [ApiConventionMethod(typeof(MCHApiConventions), nameof(MCHApiConventions.Register))]
