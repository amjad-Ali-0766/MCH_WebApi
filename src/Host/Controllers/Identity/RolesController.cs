using MCH.Application.Identity.Roles;
...
public class RolesController : VersionNeutralApiController
{
    ...
    [HttpGet]
    [MustHavePermission(MCHAction.View, MCHResource.Roles)]
    ...
    [MustHavePermission(MCHAction.View, MCHResource.RoleClaims)]
    ...
    [MustHavePermission(MCHAction.Update, MCHResource.RoleClaims)]
    ...
    [HttpPost]
    [MustHavePermission(MCHAction.Create, MCHResource.Roles)]
    ...
    [HttpDelete("{id}")]
    [MustHavePermission(MCHAction.Delete, MCHResource.Roles)]
